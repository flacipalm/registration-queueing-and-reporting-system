...
int main()
{
    ...
    int file_num = 1;
    input_generator(0, 20000, test_database->database);
    const char filename0[file_num][51] = {"./My_example/New_examplefile1.txt"};
    test_database->register_file(filename0, file_num, all_queue);

    input_generator(1, 20000, test_database->database);
    const char filename1[file_num][51] = {"./My_example/New_examplefile2.txt"};
    test_database->register_file(filename1, file_num, all_queue);

    input_generator(2, 20000, test_database->database);
    const char filename2[file_num][51] = {"./My_example/New_examplefile3.txt"};
    test_database->register_file(filename2, file_num, all_queue);

    input_generator(3, 20000, test_database->database);
    const char filename3[file_num][51] = {"./My_example/New_examplefile4.txt"};
    test_database->register_file(filename3, file_num, all_queue);

    input_generator(4, 20000, test_database->database);
    const char filename4[file_num][51] = {"./My_example/New_examplefile5.txt"};
    test_database->register_file(filename4, file_num, all_queue);

    //=================================READ INFORMATION FROM FILE=======================
    //int file_num = 5;
    // const char filename[file_num][51] = {"examplefile1.txt",
    //                                      "examplefile2.txt",
    //                                      "examplefile3.txt",
    //                                      "examplefile4.txt",
    //                                      "examplefile5.txt"};

    //test_database->register_file(filename, file_num1, all_queue);
    ...
    end_time->year = 2021; end_time->month = 1; end_time->day = 1;
    ...
    int id_num_withdraw1 = 1674459; 
    // His/Her registration time is 2019-1-1-00-00-00. 
    // Normal case: His/Her original appointment time is 2019-2-18-10-00-00.
    ...
    int id_num_withdraw2 = 1757751; 
    // His/Her registration time is 2019-1-1-00-00-00. 
    // Normal case: His/Her original appointment time is 2019-1-29-8-00-00.
    Time *set_withdraw2 = new Time(); // set->minute and set->sec should be 0. set->hour is either 0 or 12.
    set_withdraw2->year = 2019; set_withdraw2->month = 1; set_withdraw2->day = 20; // He/She withdraws on 2019-1-20-00-00.
    ...
    int id_num_ddl = 1100415;
    // His/Her registration time is 2019-1-1-00-00-00. 
    // Normal case: His/Her original appointment time is 2019-2-18-10-00-00.
    Time *ddl = new Time(); // set->minute and set->sec should be 0. set->hour is either 0 or 12.
    ddl->year = 2019; ddl->month = 1; ddl->day = 8; // He/She's treatment due to 2019-1-6-00-00
    Time *set_ddl = new Time();  // set->minute and set->sec should be 0. set->hour is either 0 or 12.
    set_ddl->year = 2019; set_ddl->month = 1; set_ddl->day = 6; // He/She offers a letter with ddl on 2019-1-5-00-00.
    // Changing case: 
    
    // 3. Test "adjust_profession"
    int id_num_adj_pro = 1458533;
    // His/Her registration time is 2019-1-1-00-00-00.
    // Normal case: His/Her professional category is 5 and appointment time is 2019-1-23-13-00-00.
    ...
    // 4. Test "adjust_risk"
    int id_num_adj_risk = 1000627;
    // His/Her registration time is 2019-1-1-00-00-00.
    // Normal case: His/Her risk status is 3 and appointment time is 2019-2-4-10-00-00.
    // Changing
